...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names={"Kilometre", "Metre", "Centimetre", "Millimetre", "Micrometre", "Nanometre", "Mile",
            "Yard yd", "Foot ft", "Inch in"};
    double[] values = {0.001, 1, 100, 1000, 1000000, 1000000000, 0.000621371, 1.09361, 3.28084, 39.3701};
